...
const Homee = () => {
  ...
  return (
    <div className="banner h-screen bg-black p-40 text-white">
      <div className="pt-20">
      ...
      <div className="pt-10">
        <button className="w-64 p-10 flex items-center justify-center border border-gray-700 bg-emerald-500 rounded-md relative overflow-hidden group">
          {/* Default Text */}
