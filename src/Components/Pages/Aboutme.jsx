...
const Aboutme = () => {
  return (
    <div className="min-h-screen w-screen bg-black text-white mx-auto p-36">
      ...
      <p className="mt-10 leading-[30px] text-gray-400 border-l-2  pl-2 border-emerald-500">
      ...
      <p className="mt-5 leading-[30px] text-gray-400 border-l-2  pl-2 border-emerald-500">
